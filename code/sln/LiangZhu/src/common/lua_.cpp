...
int CLua::doFile(const tchar* _file_path)
{
...
int CLua::doString(const tchar* _chunk)
{
...
bool CLua::loadInteger(const tchar* _name, int& value)
{
...
bool CLua::loadDouble(const tchar* _name, double& _value)
{
    if (!_name) return false;
...
bool CLua::loadBoolean(const tchar* _name, bool& _value)
{
    if (!_name) return false;
...
bool CLua::loadObject(const tchar* _tableName, LuaObject& _obj)
{
...
bool CLua::loadString(const tchar* _tableName, const tchar* _name, CStdString& _value)
{
    bool b = false;
...
bool CLua::loadInteger(const tchar* _tableName, const tchar* _name, int& _value)
{
    bool b = false;
    if (!_tableName || !_name)  return b;
...
bool CLua::loadDouble(const tchar* _tableName, const tchar* _name, double& _value)
{
    bool b = false;
    if (!_tableName || !_name)  return b;
...
bool CLua::loadBoolean(const tchar* _tableName, const tchar* _name, bool& _value)
{
    bool b = false;
    if (!_tableName || !_name)  return b;
...
bool CLua::loadRecords(const tchar* _tableName, std::vector<LuaObject>& _records)
{
    if (!_tableName) return false;
...
bool CLua::loadArray_s(const tchar* _tableName, std::vector<CStdString>& _vec)
{
    if (!_tableName) return false;
...
bool CLua::loadArray_i(const tchar* _tableName, std::vector<int>& _vec)
{
    if (!_tableName) return false;
    bool r = false;
    int n = lua_gettop(m_luaState);
...
bool CLua::loadArray_d(const tchar* _tableName, std::vector<double>& _vec)
{
    if (!_tableName) return false;
    bool r = false;
    int n = lua_gettop(m_luaState);
...
int CLua::callFunc(const tchar* _func, const tchar* _params, ...)
{
    if (!_func) return -1;
...
int CLua::regFunc(const tchar* _funName, lua_CFunction _func)
{
...
int CLua::regClass(const tchar* _className, luaL_Reg* _classMems)
{
