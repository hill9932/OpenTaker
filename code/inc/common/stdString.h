...
//		}
    ...
    MYTYPE&  TrimLeft(CT tTrim, size_t& pos)
    {
        pos = this->find_first_not_of(tTrim);
        this->erase(0, pos);
        return *this;
    }
    ...
    MYTYPE&  TrimLeft(PCMYSTR szTrimChars, size_t& pos)
    {
        pos = this->find_first_not_of(szTrimChars);
        this->erase(0, pos);
        return *this;
    }
    ...
    MYTYPE&  TrimRight(CT tTrim, size_t& pos)
    {
        MYSIZE nIdx	= this->find_last_not_of(tTrim);
        this->erase(MYBASE::npos == nIdx ? 0 : ++nIdx);
        pos = nIdx;
    ...
    MYTYPE&  TrimRight(PCMYSTR szTrimChars, size_t& pos)
    {
        MYSIZE nIdx	= this->find_last_not_of(szTrimChars);
        this->erase(MYBASE::npos == nIdx ? 0 : ++nIdx);
        pos = nIdx;
