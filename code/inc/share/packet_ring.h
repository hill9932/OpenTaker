...
#define SUBPROCESS_SIGNAL_NAME  "VP_FIRE_BULLET"    // the global event name
...
VPAGENT_API
int ProcessPacket(packet_header_t* _header, byte* _data, PacketMeta_t* _metaInfo);
