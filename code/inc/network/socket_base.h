#ifndef __HILUO_SOCKET_BASE_INCLUDE_H__
#define __HILUO_SOCKET_BASE_INCLUDE_H__
...
#define MAX_BUFFER_LEN  1024
    ...
    public:
        static LPFN_ACCEPTEX    m_lpfnAcceptEx;         // point to AcceptEx  
